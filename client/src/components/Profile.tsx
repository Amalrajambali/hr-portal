                        ...
                        {!isUpdate ?
                          ...
                          : <form>
                            ...
                            <div className="form-group">
                              ...
                              <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value={currentUser?.email} name='email' onChange={handleInputChange} />
                            </div>
                            <div className="form-group">
                              <div className="control">
                                <label className="label" style={{ fontWeight: "450" }}>District</label>
                                <div className="select">
                                  <select onChange={handleInputChange} name="city">
                                    <option >{currentUser?.city ? currentUser.city : "Select City"}</option>
                            ...
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control" id="exampleInputPassword1" placeholder="Department" value={currentUser?.department} name="department" onChange={handleInputChange} />
                            </div>
                            <div className="form-group">
                              <label >Phone</label>
                              <input type="number" className="form-control" name="phone" id="exampleInputPassword1" placeholder="Phone" value={currentUser?.phone} onChange={handleInputChange} />
                            </div>
